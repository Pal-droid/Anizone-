...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log("[v0] Proxying AnimePahe image:", imageUrl)
    ...
    console.log("[v0] Successfully proxied AnimePahe image, size:", imageBuffer.byteLength, "bytes")
    ...
    console.error("[v0] Error proxying AnimePahe image:", error)
