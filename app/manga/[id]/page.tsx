...
type Chapter = { title: string; url: string; date: string; isNew?: boolean }
type Volume = { name: string; image?: string; chapters: Chapter[] }
type MangaData = {
  title: string
  image: string
  type: string
            ...
            <div className="flex gap-4 p-6">
              ...
              <div className="flex-1 flex flex-col gap-3">
                ...
                <div className="flex flex-wrap items-center gap-2 text-sm">
                  ...
                  {mangaData?.year && (
                    <div className="flex items-center gap-1 max-w-[5rem] truncate">
                      <Calendar size={16} className="text-muted-foreground" />
                      <span className="text-muted-foreground truncate">{mangaData.year}</span>
                    </div>
                  )}
                </div>
                ...
                {mangaData?.genres.length > 0 && (
                  <div>
                    <div className="text-sm font-medium mb-1">Generi:</div>
