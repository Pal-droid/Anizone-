...
function MaintenanceNotice() {
  useEffect(() => {
    ...
    modal.innerHTML = `
      ...
      <h2 style="font-size: 20px; font-weight: 600; margin-bottom: 16px; color: #0f172a;">Sezione Manga in Manutenzione</h2>
      <p style="color: #64748b; margin-bottom: 24px; line-height: 1.5;">
        La sezione manga è attualmente in manutenzione per miglioramenti del sistema. 
        Riprova più tardi. Puoi comunque accedere alle altre sezioni del sito.
      </p>
      <a href="/" style="
